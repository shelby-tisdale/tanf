...
sipp_all_goals <- sipp_participants |>
  ...
  select(ssuid, pnum, monthcode, year, tage, state, eeduc, eorigin, trace, esex, ecitizen, tceb, erelrpe, ejb1_scrnr,
  # tanf variables
...
sipp_goal2 <- sipp_all_goals |>
  ...
  group_by(household_id, state, fiscal_year, goal2, pct_unobligated, party) |>
  summarize(
...
X_{j5} = \text{percent of unobligated funds for state j}
$$
...
# sipp_all_goals <- read_csv("sipp_all_goals.csv")
```
>>>>>>> 0b8755b198c764eaba21bb91c4654ba2cdc546ed
