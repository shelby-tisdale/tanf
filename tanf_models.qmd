...
sipp_all_goals <- sipp_participants |>
  ...
  # edit variable types
  mutate_at(c('month', 'year', 'fiscal_year', 'state', 'education', 'ethnicity', 'race', 'sex', 'citizenship', 'in_goal1', 'in_goal2', 'in_goal3', 'in_goal4', 'goal1', 'goal2', 'goal3', 'goal4', 'received_job_training', 'hh_married_month', 'tanf_begin_month', 'tanf_initial_year', 'tanf_end_month', 'tanf_coverage_type', 'tanf_owner', 'tanf_continue_flag', 'tanf_received_month', 'tanf_received_year', 'party'), as.factor)
