...
hexbin_unobligated <- ggplot(us_hexbin) +
  ...
  geom_sf_text(aes(label = iso3166_2), color = "black", family = "Garamond") +
  theme_void() +
  scale_fill_distiller(direction = 1, palette = 5, limits = c(0,1), labels = percent, guide = guide_colorbar(title.position = "top", title.hjust = 0.5)) +
  ...
  labs(fill = "Average percent of TANF funds unobligated",
       #title = "Average Percent Unobligated TANF Funds by State",
       #subtitle = "Fiscal years 2017-2022"
       )

ggsave(hexbin_unobligated, filename = "hexbin_unobligated.png", width = 6, height = 4, units = "in")
...
ggsave(hexbin_cash_assist, filename = "hexbin_cash_assist.png", width = 6, height = 4, units = "in")
...
ggsave("unobligated_bar.png", width = 6, height = 4)
