...
# read tanf federal expenditures data
...
tanf_state_year <- tanf |>
  ...
  select(state, fiscal_year, pct_unobligated, pct_program_mgmt,
         pct_basic_assistance, pct_work_ed, pct_fatherhood_programs,
         pct_pregnancy_prevention, pct_child_welfare)
```
...
# create table 1 (household-level characteristics)
sipp_all_goals |>
   mutate(
