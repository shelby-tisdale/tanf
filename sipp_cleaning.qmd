...
households_with_children <- sipp |>
  ...
  group_by(sample_unit_id, interview_address_id, hh_address_id, residence_address_id, year, month) |>
  ...
  select(sample_unit_id, interview_address_id, hh_address_id, year, month) |>
  distinct()
...
household_poverty <- sipp |>
  group_by(sample_unit_id, interview_address_id, residence_address_id, hh_address_id, year, month) |>
