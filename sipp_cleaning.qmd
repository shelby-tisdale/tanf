...
households_with_children <- sipp |>
  ...
  group_by(sample_unit_id, interview_address_id, hh_address_id,
           residence_address_id, year, month, state) |>
...
# match all children to reference parent
# don't know if this is helpful
children <- children |>
  left_join(parent_child_lookup, by = join_by(
    sample_unit_id, person_num == child_person_num, year, month))
